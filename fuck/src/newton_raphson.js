...
class Newtonraphson extends Component {
    ...
    componentDidMount(){
        axios.get("http://192.168.99.100:3001/api/newraphs").then(res=>{
...
render() {
    ...
    <Layout style={{ minHeight: '100vh' }}>
        ...
        <h2 style={{ color: "black", fontWeight: "bold" }}>Newton-raphson</h2>
            ...
            <h2>x<sub>0</sub></h2><Input size="large" name="x0" style={{ width: 200 }}></Input><br /><br />
            <Button onClick={() => this.newton_raphson(parseFloat(this.state.x0))}
